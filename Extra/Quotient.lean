...
protected theorem ind₃ {motive : Quotient sa → Quotient sb → Quotient sc → Prop}
...
protected theorem ind₄ {motive : Quotient sa → Quotient sb → Quotient sc → Quotient sd → Prop}
